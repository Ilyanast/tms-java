...
@CdsName(FreightOrderUIService_.CDS_NAME)
public interface FreightOrderUIService extends CqnService {
  ...
  interface Application extends ApplicationService, FreightOrderUIService {
  }

  interface Remote extends RemoteService, FreightOrderUIService {
  }

  interface Draft extends DraftService, FreightOrderUIService {
  }
}
