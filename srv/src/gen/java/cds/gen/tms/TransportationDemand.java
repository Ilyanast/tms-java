...
public interface TransportationDemand extends CdsData {
  String ID = "ID";
  ...
  List<TransportationDemandItem> getItems();

  void setItems(List<? extends Map<String, ?>> items);

  TransportationDemand_ ref();

  static TransportationDemand create() {
    return Struct.create(TransportationDemand.class);
  }

  static TransportationDemand of(Map<String, Object> map) {
    return Struct.access(map).as(TransportationDemand.class);
  }

  static TransportationDemand create(String id) {
    Map<String, Object> keys = new HashMap<>();
    keys.put(ID, id);
    return Struct.access(keys).as(TransportationDemand.class);
  }
}
