...
@CdsName("TransportationDemandUIService.TransportationDemandItem")
...
public interface TransportationDemandItem_ extends LinkedStructuredType<TransportationDemandItem, TransportationDemandItem_> {
  ...
  String CDS_NAME = "TransportationDemandUIService.TransportationDemandItem";
  ...
  TransportationDemandItem_ SiblingEntity();

  TransportationDemandItem_ SiblingEntity(Function<TransportationDemandItem_, CqnPredicate> filter);
